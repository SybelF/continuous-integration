# Continuous Integration [![tests](https://github.com/SybelF/continuous-integration/actions/workflows/tests.yml/badge.svg)](https://github.com/SybelF/continuous-integration/actions/workflows/tests.yml)
